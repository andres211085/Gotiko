...
public class Events : MonoBehaviour
{
		...
		private void OnGameCloseDialogClick (Object ob)
		{
				...
				//Pausamos el mundo y el Player
				//Ponemos Kinematic al jugador al pausar el juego para evitar físicas
				...
				world.speed=1f;
				Animator comeGotiko=GameObject.Find("ComeGotiko").GetComponent<Animator>();			
				comeGotiko.speed=1f;
		}
		...
		private IEnumerator LoadGameScene ()
		{
				...
				Application.LoadLevel ("level"+Stage.selectedElementId);
		}
